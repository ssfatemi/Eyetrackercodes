...
%
% 7/3/14 srresearch
%                fixed issue that prevented the addition of "HTARGET" to record
%                possible target data for EyeLink Remote
...
%imageList = get_imgs('selection1_bmp/');
imageList = {'town.bmp' 'town_blur.bmp' 'composite.bmp'};
%dummymode=0;%eye tracker ON
dummymode=1;%eye tracker OFF
try 
    % STEP 1
